<?php
$target_dir = "Assets/"; // you have to create this directory in the folder where you have the PHP file
...
// Verifies if the image file is an actual image or a fake image
